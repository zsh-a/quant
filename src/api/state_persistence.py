...
class StatePersistence:
    ...
    def __init__(self):
        config = get_section('persistence')
        self.enabled = config.get('enabled', True)
        self.checkpoint_path = Path(config.get('checkpoint_path', 'data/checkpoints'))
        self.checkpoint_interval = config.get('checkpoint_interval', 60)  # seconds
        ...
        logger.info(f"State persistence initialized: path={self.checkpoint_path}, "
    ...
    def save_checkpoint(self, session_id: str, state: Dict[str, Any], 
        ...
        try:
            ...
            logger.info(f"Checkpoint saved: session={session_id}, "
    ...
    def load_latest_checkpoint(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"Checkpoint loaded: session={session_id}, "
