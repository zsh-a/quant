...
class AKDataProcessor:
    ...
    def insert_index_stocks(self, index_code):
        ...
        try:
            ...
            '''
                  品种代码  品种名称        纳入日期
                    0   300857  协创数据  2025-12-15
                    1   300748  金力永磁  2025-12-15
                    2   300548  长芯博创  2025-12-15
                    3   300395   菲利华  2025-12-15
                    4   300255  常山药业  2025-12-15
                    5   300024   机器人  2025-06-16
                    6   300058  蓝色光标  2025-06-16
                    7   300115  长盈精密  2025-06-16
                    8   300251  光线传媒  2025-06-16
                    9   300458  全志科技  2025-06-16
                    10  302132  中航成飞  2025-02-17
                    11  300339  润和软件  2024-12-16
            '''
...
if __name__ == "__main__":
    ...
    # dp.create_etf_meta()
    # dp.update_shares()
    dp.insert_index_stocks("399673")
    # ak.index_stock_info().to_csv("index_stock_info.csv", index=False)
